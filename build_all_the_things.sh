...
# exmaple:   bash build_all_the_things.sh v0.14.1 dogecoin/dogecoin
# this will build:
...
get_latest_tag () {
  local url="curl ${masterApiEndpoint}/repos/dogecoin/dogecoin/tags"
